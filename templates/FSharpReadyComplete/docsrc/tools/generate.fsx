...
let info =
  [ "project-name", "FSharpReady"
    "project-author", "authorsPlaceHolder"
    "project-summary", "descriptionPlaceHolder"
    "project-github", "https://github.com/ownersPlaceHolder/FSharpReady"
    "project-nuget", "http://nuget.org/packages/FSharpReady" ]
...
let referenceBinaries = 
        [ 
        __SOURCE_DIRECTORY__ + "/../../src/FSharpReady/bin/Release/implementationPlaceHolder/FSharpReady.dll"     
        ]
    
let libDirs = 
    [ 
        __SOURCE_DIRECTORY__ + "/../../src/FSharpReady/bin/Release/implementationPlaceHolder/"
    ]
...
let buildReference () =
    ...
    RazorMetadataFormat.Generate( 
        ...
        sourceRepo = "https://github.com/ownersPlaceHolder/FSharpReady/tree/master/",
